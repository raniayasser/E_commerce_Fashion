...
function renderCartItems() {
    ...
    cartItems.forEach(item => {
        ...
        <tr>
                ...
                <td>${item.title}</td>
                <td>
                    <span type="button" class="btn btn-link btn-sm px-3" onclick="updateCartItem('increase',${item.id})"> + </span>
                    <span class="amount"> ${item.amount} </span>
                    <span type="button" class="btn btn-link btn-sm px-3" onclick="updateCartItem('decrease',${item.id})"> - </span>
                </td>
                <td>${item.price}.00$</td>
                <td>${item.price * item.amount}.00$</td>
                <td>
                <button type="button" onclick="deleteCartItem(${item.id})"  class="btn btn-link btn-sm px-3" data-ripple-color="dark">
